...
public class YelpAPI {
    ...
    private static final String CONSUMER_KEY = "lGtGrylgaY3ou3VX8ywO2A";
    private static final String CONSUMER_SECRET = "u4chWXl4jdiTSzySPhT9C8VZV_w";
    private static final String TOKEN = "Hi59sFAoCyaIp2VHOYU2OWwcGq5CGJza";
    private static final String TOKEN_SECRET = "-_7IFjniIIshvEWB2hSaUfjzc_E";
